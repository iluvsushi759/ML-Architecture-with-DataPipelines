...
UNION ALL
SELECT 'HOSPITALS_TRANSFORMED' AS table_name, COUNT(*) FROM ${TARGET_SCHEMA}.HOSPITALS_TRANSFORMED
UNION ALL
SELECT 'CLAIMS_TRANSFORMED' AS table_name, COUNT(*) FROM ${TARGET_SCHEMA}.CLAIMS_TRANSFORMED;